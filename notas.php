...
ver trades en consola

Object.values(MostroTrader._trades).map(t => ({id: t.order_id, status: t.internal_status, trade_action: t.trade_action, is_seller: t.is_seller, method: t.method}))
