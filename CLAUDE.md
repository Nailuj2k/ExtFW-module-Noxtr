...
- `Noxtr.logout()` — desconecta relays, limpia estado de identidad, borra `noxtr_npub`/`noxtr_nip46` de localStorage. Preserva las claves de IndexedDB (siguen por `userId`, no se borran en logout)
