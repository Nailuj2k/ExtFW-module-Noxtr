<?php
    ...
    addToZip($hzip,SCRIPT_DIR_CLASSES.'/bitcoin_rpc.class.php');
    addToZip($hzip,SCRIPT_DIR_CLASSES.'/btcpay_lightning.class.php');
    addToZip($hzip,SCRIPT_DIR_THEMES.'/noxtr');